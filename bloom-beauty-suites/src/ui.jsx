...
const STATUS_STYLE = {
  ...
  lapsing: [C.amber, C.amberLight],
  lost: [C.red, C.redLight],
  scheduled: [C.gold, C.goldLight],
  completed: [C.green, C.greenLight],
  "no-show": [C.red, C.redLight],
  "late-cancel": [C.amber, C.amberLight],
  waiting: [C.gold, C.goldLight],
  contacted: [C.rose, C.roseLight],
  booked: [C.green, C.greenLight],
};
